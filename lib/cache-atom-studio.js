...
export default {
	...
	activate(state) {
		...
		this.modalPanel.element.style.top = "100px";
	...
	configInfo() {
		...
		if (!this.modalPanel.isVisible()) {
			...
			let _self = this;
			$(this.modalPanel.item).find(".cache-atom-studio-conf-savebtn").on("click", function(e){
				
				_self.modalPanel.hide();
			});
			$(this.modalPanel.item).find(".cache-atom-studio-conf-cancelbtn").on("click", function(e){
				_self.modalPanel.hide();
			});
